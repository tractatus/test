...
\documentclass[$if(watermark)$watermark,$endif$$if(papersize)$$papersize$paper,$endif$$if(fontsize)$$fontsize$,$else$9pt,$endif$$if(manuscript_mode)$$if(lineno)$lineno,$endif$$else$twocolumn,$endif$$if(one_sided)$$else$twoside,$endif$]{pinp}
